		...
		<div class="d-flex flex-row flex-wrap">
			<div class="col-md-6">
				<div class="featured-event row-fluid d-flex"
					 style="background-image: url('https://bccampus.ca/wp-content/themes/bcc-sage/dist/images/edtech.jpg');">
			...
			<div class="col-md-6">
				<div class="featured-event row-fluid d-flex"
					 style="background-image: url('https://bccampus.ca/wp-content/themes/bcc-sage/dist/images/flo.jpg');">
