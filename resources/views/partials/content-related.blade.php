<section class="relevant d-flex flex-row flex-wrap my-3">
	@foreach(\App\App::getRelevant($post, $post_types, $limit, $category_name) as $related_post )
		...
		@endphp
		<article class="col-md-{{$column_width}} feature-box-sm py-2" itemscope itemtype="http://schema.org/Blog">
			<a class="purple" href="{{$link}}">
			...
			<div class="border min-height-md">
				...
				<h4><a class="purple" itemprop="name" href="{{$link}}">{!! $related_post->post_title !!}</a>
				</h4>
